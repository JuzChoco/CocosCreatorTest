...
export class Ground extends Component {
    ...
    @property({
        type: Node,
        tooltip: "This is Ground1"
    })
    public ground1: Node

    @property({
        type: Node,
        tooltip: "This is Ground2"
    })
    public ground2: Node

    @property({
        type: Node,
        tooltip: "This is Ground3"
    })
    public ground3: Node

    //Ground Width Variables
    public groundWidth1: number;
    public groundWidth2: number;
    public groundWidth3: number;

    //Temp Starting Location
    ...
    startUp(){
        ...
        this.tempStartLocation1.x = 0; // Starting Point
